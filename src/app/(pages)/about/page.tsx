...
const leadership = [
    { name: 'Person 1', role: 'CEO & Founder', image: 'https://placehold.co/300x300.png', hint: 'person portrait' },
    { name: 'Person 2', role: 'Head of Operations', image: 'https://placehold.co/300x300.png', hint: 'woman portrait' },
    { name: 'Person 3', role: 'Lead Designer', image: 'https://placehold.co/300x300.png', hint: 'man portrait' },
    { name: 'Person 4', role: 'Sustainability Officer', image: 'https://placehold.co/300x300.png', hint: 'person face' },
]
...
export default function AboutPage() {
  return (
    <div className="space-y-16">
      ...
      <section>
        <Image src="https://placehold.co/1200x500.png" data-ai-hint="team meeting" width={1200} height={500} alt="Our team" className="rounded-lg object-cover w-full" />
      </section>
